...
unsigned char load_targa(const char *filename, int &width, int &height, unsigned int &format, unsigned int &type, void *&pixels)
{
...
unsigned char save_targa(const char *filename, int width, int height,
